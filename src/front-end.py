...
with st.container():
    def search_function():
        ...
        parser.add_argument('-embeddings_dir_name', type=str, default= r"C:\Users\Lenovo\Desktop\Book-Recommender-System\data\embeddings", help='the name of the directory to use embeddings from')
        ...
        if col2.button("Search", key='searchbutton', help='Click to perform search')or (prev_qry != search_query):
            ...
            col2.markdown('<div class="rectangular-shape" style="text-align: center; text-decoration: none; border-bottom_style: none; font-size: 30px"> Search Results: </div>', unsafe_allow_html=True)
            result_list = []
